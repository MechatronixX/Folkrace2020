...
// If you start the channel count at 1, you might get conflicts with other
// libraries defauling to 1. This is a quick workarond to get this to work with the
// motor driver
constexpr int LEDC_CHANNEL_OFFSET = 2;
